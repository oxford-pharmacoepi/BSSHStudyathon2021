...
# github packages -----
#please install the following versions of packages to ensure consistency if not already installed
...
#download the static version of cohort diagnostics this package was made from
install_github("edward-burn/CohortDiagnostics", branch = "DiagAi", force=TRUE)
library(CohortDiagnostics)

# Load the study package ----- 
# First, make sure you are currently inside the WristArthritis.Rproj - you can see this at the top left
# Then navigate to Build in the top right panel, and click "Install and Restart" and build the package
library(WristArthritis)
...
# Run the study 
WristArthritis::runCohortDiagnostics(connectionDetails = connectionDetails,
